...
class CreateProductController {
    handle(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const product = new CreateProductService_1.CreateProductService();
            if (!request.files || Object.keys(request.files).length === 0) {
                ...
                const menu = yield product.execute({ name, price, description, banner: resultfile.url, category_id });
